/*
Clean Tanzania-2014 Module 2 Data From SDI Survey
...
*****************************************************************************
	...
	use "$raw/SDI_Tanzania-2014/SDI_Tanzania-2014_Module2_Raw.dta", clear
	...
	compress
	saveold "$clean/SDI_Tanzania-2014/tanzania-2014_roster_clean.dta", replace v(12)
